...
import { Provider, ClassProvider, ExistingProvider, FactoryProvider, TypeProvider, ValueProvider } from './di/provider';
...
export { Provider, ClassProvider, ExistingProvider, FactoryProvider, TypeProvider, ValueProvider };
export { ReflectiveInjector, ReflectiveInjector_ } from './di/reflective_injector';
export { ReflectiveKey } from './di/reflective_key';
export { ReflectiveDependency, ResolvedReflectiveFactory, ResolvedReflectiveProvider, ResolvedReflectiveProvider_, resolveReflectiveProviders, mergeResolvedReflectiveProviders, constructDependencies } from './di/reflective_provider';
...
export declare const CORE_PROVIDERS: Provider[];
